...
本轮结论：54 只通过，1 只需要修复。银狼的紫色和蓝色发梢、昔涟的粉色和青色服装、绿色角色及其他角色本色均按主体细节保留，没有因为颜色相似而判作背景残留。
...
余下这一只修复时必须逐帧确认，避免破坏角色本身的绿色或紫色细节。
...
### 已修复并复核、边缘已审查需修复：v1（1）

- `yume-boundary--andy-meow`：历史复核证据 `663794d`；本轮确认仍有底色边缘或底块。
