...
- Start at [codexpet.top](https://codexpet.top): ask the community to make a pet, or let ChatGPT create, finish, and submit your own without a full clone
...
AI contributors should follow [`.agents/skills/submit-codex-pet`](./.agents/skills/submit-codex-pet). ChatGPT can start from references or existing pet files; the completed pet should normally become a focused pull request through the GitHub API, without downloading the existing pet catalog.
