...
- Green CI posts a Pet review summary. Repository-owner Codex Avatars submissions merge automatically; other submissions merge after a write-enabled maintainer adds `approved-pet` or comments `/approve-pet`
